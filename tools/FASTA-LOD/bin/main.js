...
>>>>>>> 73904333a24bfb738ecf6876e531a0862f17cb05
(function () { "use strict";
...
<<<<<<< HEAD
	if(args.length == 0) {
		Console.printFormatted(Console.errorPrefix + "Pass chromosome number as an argument" + "\n",2);
		process.exit(1);
		return;
	}
	...
	var generatedFilePaths = Main.convertFastaFile(Main.fastaFilePath);
=======
	if(args.length < 1) {
...
<<<<<<< HEAD
Main.convertFastaFile = function(path,chunkSize_bytes) {
=======
...
<<<<<<< HEAD
		sys_FileSystem.createDirectory(Main.outputDirectory);
		var path1 = haxe_io_Path.join([Main.outputDirectory,filename]);
=======
...
<<<<<<< HEAD
Main.fastaFilePath = "data/Homo_sapiens.GRCh37.dna.primary_assembly.fa";
Main.sequenceNameFilter = new EReg("(1) dna:chromosome chromosome:GRCh37","");
Main.outputDirectory = "_generated";
=======
>>>>>>> 73904333a24bfb738ecf6876e531a0862f17cb05
Main.main();
})();
