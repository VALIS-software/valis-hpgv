...
export declare class XAxis extends Object2D {
    ...
    constructor(x0?: number, x1?: number, color?: ArrayLike<number>, fontSizePx?: number, fontPath?: string, offset?: number, snap?: number, startFrom?: number, tickSpacingPx?: number);
    setRange(x0: number, x1: number): void;
    applyTransformToSubNodes(root?: boolean): void;
    protected labelsNeedUpdate(): void;
